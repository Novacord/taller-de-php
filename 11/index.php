...
if (isset($_POST['sistema1'])){
  ...
  $planetasSinDuplicados1 = array_unique($_POST['sistema1']);

  $planetasSinDuplicados2 = array_unique($_POST['sistema2']);

  $form = '';
  foreach ($planetasSinDuplicados1 as $key => $NombreP) {
    $form .= '<div class="login-form">
    <p class="mesage">sistema solar1 </p>
    <P class="mesage"> tienen diferente '.$NombreP.'</P>
    </div>';
  }

  foreach ($planetasSinDuplicados2 as $key => $NombreP) {
    $form .= '<div class="login-form">
    <p class="mesage">sistema solar2 </p>
    <P class="mesage"> tienen diferente '.$NombreP.'</P>
    </div>';
  }
